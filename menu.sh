...
echo " "
echo -e "${txtblue} ┌────────────────────────────────────────────┐ "
echo -e "${txtblue} │[R]        Welcome to Brutus Panel          │ "
echo -e "${txtblue} └────────────────────────────────────────────┘ "
...
do
    case $opt in
        "http installation")
            wget -q -O https.sh https://raw.githubusercontent.com/mak-iptv/sat-albaniarepo/main/installalbi.sh && chmod +x https.sh && ./https.sh
            break
            ;;
        "http installation")
