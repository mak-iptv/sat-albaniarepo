...
def menuoptions():
    ...
    call = dialog.select('[B][COLOR=blue]Maverick Pair-ing System[/COLOR][/B]', [
	...
	'[B][COLOR=blue] **** Other Heplful Sites **** [/COLOR][/B]',
	'[B][COLOR=red]      Follow me on Twitter for Updates[/COLOR][/B]',
	'[B][COLOR=red]      Top Tutorials[/COLOR][/B]',
	'[B][COLOR=red]      Kodi Apps[/COLOR][/B]',
	'[B][COLOR=red]      Best For Kodi[/COLOR][/B]',
	'[B][COLOR=red]      Maverick Website[/COLOR][/B]',
	'[B][COLOR=red]      Where To Watch Football Games[/COLOR][/B]',
	'[B][COLOR=blue] **** Maverick Help/Support & Updates **** [/COLOR][/B]',
	'[B][COLOR=lime]      Maverick Facebook Group[/COLOR][/B]',])
...
def function18():
    if myplatform == 'android': # Android 
        opensite = xbmc.executebuiltin( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'http://mavericktv.net/' ) )
    else:
        opensite = webbrowser . open('http://mavericktv.net/')
